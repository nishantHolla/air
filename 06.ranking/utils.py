...
def term_frequency_file(d: Path | str) -> Path:
    """
    Returns the expected path for the term frequency json file for the given directory

    Args:
        d (Path | str): Directory to append the file name to

    Returns:
        (Path): The path to the term frequency json file
    """
    return Path(d) / "term_frequency.json"


def document_frequency_file(d: Path | str) -> Path:
    """
    Returns the expected path for the document frequency json file for the given directory

    Args:
        d (Path | str): Directory to append the file name to

    Returns:
        (Path): The path to the document frequency json file
    """
    return Path(d) / "document_frequency.json"


def inverse_document_frequency_file(d: Path | str) -> Path:
    """
    Returns the expected path for the inverse document frequency json file for the given directory

    Args:
        d (Path | str): Directory to append the file name to

    Returns:
        (Path): The path to the inverse document frequency json file
    """
    return Path(d) / "inverse_document_frequency.json"
...
def read_dataset(dataset_file: Path | str) -> list[T_document]:
    ...
    if Path(dataset_file).suffix == ".json":
