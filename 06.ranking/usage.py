...
TFIDF_USAGE = """
    tfidf: Index the movies dataset along with its tfidf
        arg0: Path to the dataset file
        arg1: Path to the directory that will contain the index.json, database.json and tfidf files
"""

TFIDF_QUERY_USAGE = """
    tfidf_query: Perfrom query using tfidf. Print top k documents with their score
        arg0: Path to the directory that will contain the index.json, database.json and tfidf files
"""
